...
const char* password = "<YOUR-WIFI-ID>";
...
"-----BEGIN CERTIFICATE-----\n" \
"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXoZIhvcNAQEL\n" \
...
"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX4W9zeT6hb\n" \
...
void setup() {
  ...
  //you may not have a builtIn-LED
  pinMode(LED, OUTPUT);
  digitalWrite(LED, LOW); //turn LED off, active low
}
...
sprintf(fakeData,"{\"state\": {\"reported\": {\"uptime\": %lu, \"Truck weight\": %d, \"lat\":%2.7f, \"long\": %3.7f, \"message\": \"%s\"}}}",millis()/1000,weight,latt,lon,Mes);
