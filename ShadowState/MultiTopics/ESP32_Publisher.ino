...
"-----BEGIN CERTIFICATE-----\n" \
"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXZIhvcNAQEL\n" \
...
"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX1r4W9zeT6hb\n" \
  ...
  if ( ! pubSubClient.connected()) {
    ...
    while ( ! pubSubClient.connected()) {
     ...
     //Different ClientID than Subscriber. Reccomened it is a registered 'Thing'
      pubSubClient.connect("<YOUR-CLIENTID>");
