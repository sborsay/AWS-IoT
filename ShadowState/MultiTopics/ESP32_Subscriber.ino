...
const char* awsEndpoint = "<AWS-ID>-ats.iot.<AWS_REGION>.amazonaws.com";
...
"-----BEGIN CERTIFICATE-----\n" \
"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXvcNAQEL\n" \
  ...
  if ( ! pubSubClient.connected()) {
    ...
    while ( ! pubSubClient.connected()) {
     ...
     //Different ClientID than Subscriber. Reccomened it is a registered 'Thing'
      pubSubClient.connect("<UNIQUE-CLIENT_ID>");
      delay(1000);
    }
    Serial.println(" connected");
    pubSubClient.subscribe("$aws/things/<YOUR-THING>/shadow/update/accepted");
